    ...
    <?php 
        ...
        if ($_SESSION['city'] != '0') {
            ...
            if ($_SESSION['event_sort'] == 1) {
                ...
                $sql = "SELECT * FROM events WHERE event_userid != '$id' AND event_country = '$country' AND event_state = '$state' AND event_city = '$city' AND event_date > '$date_now' ORDER BY event_likes DESC, event_date ASC LIMIT 4";
            }
            ...
            if ($_SESSION['event_sort'] == 1) {
                ...
                $sql = "SELECT * FROM events WHERE event_userid != '$id' AND event_country = '$country' AND event_date > '$date_now' ORDER BY event_likes DESC, event_date ASC LIMIT 4";
            }
            else if($_SESSION['event_sort'] == 4) {
